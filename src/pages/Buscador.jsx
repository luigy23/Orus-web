...
const Buscador = () => {
  return (
    <main className='h-screen bg-orus-gradient flex flex-col items-center pt-20 pb-20 text-white'>
        ...
        <div className=' absolute bottom-6  w-full flex flex-col items-center justify-center gap-4 p-4'>
            <button className='bg-orus-primary/50 px-4 py-2  rounded-full flex justify-between items-center w-3/4 hover:bg-orus-primary/70 transition-all duration-300'>
            <span>Buscar</span>
